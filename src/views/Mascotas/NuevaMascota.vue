            ...
            <div class="col-md-9">
                <b-overlay :show="validacionR" rounded="sm">
                    <b-form-group label-cols-lg="12" label="Nueva Mascota" label-size="lg" label-class="font-weight-bold pt-0" class="mb-0 col-md-12" >
                        ...
                        <b-button :disabled="validacionR" pill variant="primary" :style="{marginTop:'20px'}" >Guardar</b-button >
                    </b-form-group>
                </b-overlay>
            </div>
        </div>
...
<script>
import Select from './Componentes/Select.vue';
import Vacunas from './Componentes/Vacunas.vue';
import Imagen from './Componentes/Image.vue';
export default {
    data() {
        return {
            validacionR: false
